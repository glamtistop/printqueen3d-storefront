        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4 text-sm">
              Made-to-order 3D prints, NFC stands, custom gifts, and more. Handcrafted in Los Angeles with precision and care.
            </p>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">Los Angeles, Altadena, Long Beach, Hawthorne, West Covina</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-brand-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@printqueen3d.com" className="text-gray-300 hover:text-brand-green">
                  hello@printqueen3d.com
                </a>
              </div>
            </div>
          </div>
